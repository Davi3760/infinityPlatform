...
Mario.LevelGenerator.prototype = {
    CreateLevel: function(type, difficulty,_level) {
        ...
        this.Odds[Mario.Odds.Cannon] =  2 * difficulty;
    ...
    BuildZone: function(level, x, maxLength) {
        var t = (Math.random() * this.TotalOdds+5) | 0, type = 0, i = 0;
        for (i = 0; i < this.Odds.length; i++) {
            if (this.Odds[i] <= t) {
                type = i;
            }
        ...
        switch (type) {
            case Mario.Odds.Straight:
                return this.BuildStraight(level, x+this.inicio, maxLength, false);
            case Mario.Odds.HillStraight:
                return this.BuildHillStraight(level, x+this.inicio, maxLength);
            case Mario.Odds.Tubes:
                return this.BuildCannons(level, x+this.inicio, maxLength);
            case Mario.Odds.Jump:
                return this.BuildJump(level, x+this.inicio, maxLength);
            case Mario.Odds.Cannons:
                return this.BuildCannons(level, x+this.inicio, maxLength);
        }
        return 0;
        //return this.BuildStraight(level, x+this.inicio, x+this.inicio+100,false);
    },
    ...
    BuildJump: function(level, xo, maxLength) {
        ...
        //alert('xo:'+xo+' maxLength: '+maxLength+' conta: '+(maxLength-xo));
